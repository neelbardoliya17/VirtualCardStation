...
<head>
    ...
    <!--Favicon-->
        <link rel="icon" href="<?php echo base_url('assets/user_assets/favicon/big_img/') . $detail['favicon_image']; ?>" />
    ...
    .mainmenu-area ul.nav.navbar-nav > li a:after {
        background-color:<? echo $detail['primary_color']; ?>
    }
    .cl
    {
        color:<? echo $detail['primary_color']; ?>;
        padding:10px;
        <? if($color['icon_outline']=="1") { ?>
        
        border:1px solid black;
        border-radius:10%;
        <? } ?>
        background-color:<? echo $detail['background_color']; ?>
    ...
    color:<? echo $detail['primary_color']; ?>;
    border-radius: 50px;
    border: 2px solid <? echo $detail['primary_color']; ?>;
    transition: all 0.3s ease;
    }
    .items1 span.active,
    .items1 span:hover {
    color: #fff;
    background: <? echo $detail['primary_color']; ?>;
    }
        .gallery1 {
        display: flex;
        flex-wrap: wrap;
...
<body class="home-slider">
            ...
            <nav id="mainmenu" class="mainmenu-area">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" style="padding:15px;" href="#"><img style="height:50px;"
                                src="<? echo base_url().'assets/user_assets/logo/big_img/'.$detail['logo_image']; ?>" alt=""></a> <!-- main logo here -->
                    </div>
    ...
    <div class="slider">
        ...
        <div class="slides">
            ...
            <p class="slide-desc" style="display:none">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue,
                ...
                ac diam.</p>
            <img src="<? echo base_url().'assets/user_assets/slider/big_img/'.$detail['slider_image1']; ?>">
        ...
        <div class="slides">
            ...
            <p class="slide-desc" style="display:none">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue,
                ...
                scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla
                ac diam.</p>
            <img src="<? echo base_url().'assets/user_assets/slider/big_img/'.$detail['slider_image2']; ?>">
            ...
            <div class="container"> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6">
                        <div class="single-service"  style="margin-bottom:0px;">
                            <div class="icon">
                                <a class="cl" target="_blank" href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $me; ?>"><i
                                        class="fa fa-whatsapp"></i></a>
                            </div>
                            <h3><a target="_blank"href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $me; ?>">Whatsapp</a></h3>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="get-address">
                            ...
                            <div class="s-address">
                                ...
                                <h4>Phone <span>+<a style="font-weight: bold;" href="tel:<? echo $detail['contact_no']; ?>"><? echo $detail['contact_no']; ?></a></span>
        <? if($detail['alternate_contact1']!='') { ?><span>+<a href="tel:<? echo $detail['alternate_contact1'] ?>"><? echo $detail['alternate_contact1']; ?></a></span> <? } ?>
        <? if($detail['alternate_contact2']!='') { ?><span>+<a href="tel:<? echo $detail['alternate_contact2']; ?>"><? echo $detail['alternate_contact2']; ?></a></span> <? } ?>
        <? if($detail['alternate_contact3']!='') { ?><span>+<a href="tel:<? echo $detail['alternate_contact3']; ?>"><? echo $detail['subcon3']; ?></a></span> <? } ?>
                                </h4>
                            </div> <!-- /.end single address -->
                            <div class="s-address">
                ...
                <div class="row">
                                ...
                                <div class="input-group-append">
                                    <div class="input-group-append-part1">
                                        <button id="whatsappshare" type="button"  class="btn btn-medium btn-greenish"
                                            style="margin-top:0px;color:#fff;background-color:<? echo $detail['primary_color']; ?>">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="purchase-text" style="margin-top: 0px; margin-bottom: 0px;">
                            ...
                            <a id="colorbtn"  download="Topaz Furniture" href="contact.vcf" class="btn btn-medium btn-greenish">Add to
                                Contact </a>
    ...
    <section id="about" class="about-area" style="padding-top:50px; padding-bottom:115px;">
        <div class="about-img">
            <style>
                .about-img {
        ...
        <div class="container">
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        ...
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image1']; ?>" alt="" >
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image2']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image3']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image4']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image5']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image6']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image8']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image9']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image10']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image11']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
            ...
            <div class="containerbrands">
                ...
                <div class="content">
                    <!-- <a href="" target=""> -->
                        <div class="content-overlay"></div>
                        <img class="content-image" width="720"  height="360" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image12']; ?>" alt="" >
                        <div class="content-details fadeIn-top fadeIn-right">
                            <!-- <h3>This is a title</h3> -->
        ...
        <!-- filter Items -->
            ...
            <div class="gallery1">
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat1']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image1']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image1']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name1']."*"; ?>"><i
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat2']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image2']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image2']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name2']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat3']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image3']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image3']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name3']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat4']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image4']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image4']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name4']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat5']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image5']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image5']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name5']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat6']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image6']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image6']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name6']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat7']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image7']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image7']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name7']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat8']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image8']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image8']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name8']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat9']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image9']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image9']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name9']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat10']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image10']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image10']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name10']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat11']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image11']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image11']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name11']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
                ...
                <div class="single-work" style="margin-bottom: 10px;" data-name="<? echo $product['product_cat12']; ?>">
                            <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image12']; ?>" alt="">
                            <div class="work-hover" >
                                <a class="popUpbtn" href="<? echo base_url().'assets/user_assets/product/'.$product['product_image12']; ?>"></a>
                                <div class="work-details" id="colorbtn">
                                    <? $messagenew=str_replace(['<p>', '</p>'], '', $detail['product_message']); ?>
                                    <a target="_blank" 
                                        href="https://wa.me/<? echo $detail['contact_no']; ?>?text=<? echo $messagenew."*"; echo $product['product_name12']."*"; ?>"><i
                                            class="fa fa-whatsapp" style="padding-right: 10px;"></i>Inquiry Now</a>
                                </div>
                            </div>
                        </div> 
    ...
    <section id="teams" class="our-work-area" style="background-color: #fafafa; padding-top:30px; padding-bottom:30px;">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image1']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image2']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image3']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image4']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image5']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image6']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image7']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image8']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image9']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image10']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image11']; ?>" alt="">
                        <div class="work-hover">
                ...
                <div class="col-md-3 col-sm-4 col-xs-6">
                    <div class="single-work">
                        <img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image12']; ?>" alt="">
                        <div class="work-hover">
        ...
        <div class="container">
            <style>
                ...
                .a-color-black .btn-greenish:hover {
                    background-color:<? echo $color['primary_color']; ?>;
                    color: #fff;
                }
            </style>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4 col-xs-12">
                    <div class="footer text-center">
                        <p >A Design by <a id="colorbtn1" href="https://www.icedinfotech.com/" target="_blank">ICED Infotech</a></p>
    ...
    <script src="<? echo base_url().'assets/js/wow.min.js'; ?>"></script>
