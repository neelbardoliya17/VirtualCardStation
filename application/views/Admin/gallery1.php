        ...
        <div class="main-panel">
                ...
                <a href="<?php echo base_url().'index.php/admin/brands/'.$userid; ?>"><button type="button" onclick="" class="btn btn-secondary ">Back</button>
                    ...
                    Basic form layout
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <h5>(Image Must be 720 X 720 Dimension)(1MB Max)</h5>
                                            <ul class="cards">
                                                ...
                                                <div class="card123">
                                                    ...
                                                    <div class="card_image"><img id="output"  src="<?php echo base_url().'assets/user_assets/galleryF/test.png' ?>" ></div>
                                                    <div class="card_content">
                                                    <h2 class="card_title"><input style="width:100%;font-size:15px;" type="file" name=""  onchange="loadFile(event)"></h2>
                                                ...
                                                <li class="cards_item">
                                                <div class="card123">
                                                    <div class="card_image"><img src="<?php echo base_url().'assets/user_assets/galleryF/test.png' ?>"></div>
                                                    <div class="card_content">
                                                    <h2 class="card_title">Image 2</h2>
                                                    <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button>
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage1" value="<?php echo $gallery['gallery_image1']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image1']!="")
                                                              { ?>
                                                                      <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image1']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image1" name="gallery_image1" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image1']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image1/'.$gallery['gallery_image1']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                    ...
                                                    <h2 class="card_title">Image 1</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage2" value="<?php echo $gallery['gallery_image2']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image2']!="")
                                                              { ?>
                                                                        <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image2']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                      </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image2" name="gallery_image2" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image2']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image2/'.$gallery['gallery_image2']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                ...
                                                <input type="hidden" name="gimage3" value="<?php echo $gallery['gallery_image3']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image3']!="")
                                                              { ?>
                                                               <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image3']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image3" name="gallery_image3" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image3']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image3/'.$gallery['gallery_image3']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 3</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage4" value="<?php echo $gallery['gallery_image4']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image4']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image4']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image4" name="gallery_image4" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image4']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image4/'.$gallery['gallery_image4']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 4</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage5" value="<?php echo $gallery['gallery_image5']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image5']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image5']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image5" name="gallery_image5" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image5']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image5/'.$gallery['gallery_image5']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 5</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage6" value="<?php echo $gallery['gallery_image6']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image6']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image6']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                         <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image6" name="gallery_image6" class="dropify"  />
                                                         <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image6']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image6/'.$gallery['gallery_image6']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 6</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage7" value="<?php echo $gallery['gallery_image7']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image7']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image7']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                     </div> 
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image7" name="gallery_image7" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image7']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image7/'.$gallery['gallery_image7']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 7</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage8" value="<?php echo $gallery['gallery_image8']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image8']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image8']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                      </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image8" name="gallery_image8" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image8']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image8/'.$gallery['gallery_image8']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 8</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage9" value="<?php echo $gallery['gallery_image9']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image9']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image9']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image9" name="gallery_image9" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image9']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image9/'.$gallery['gallery_image9']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 9</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage10" value="<?php echo $gallery['gallery_image10']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image10']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image10']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                       </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image10" name="gallery_image10" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image10']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image10/'.$gallery['gallery_image10']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 10</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage11" value="<?php echo $gallery['gallery_image11']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image11']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image11']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                      </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image11" name="gallery_image11" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image11']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image11/'.$gallery['gallery_image11']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 11</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="gimage12" value="<?php echo $gallery['gallery_image12']; ?>" />
                                                    <div class="card_image">
                                                        ...
                                                        <?php if($gallery['gallery_image12']!="")
                                                              { ?>
                                                               <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/galleryF/' . $gallery['gallery_image12']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                      </div>
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="gallery_image12" name="gallery_image12" class="dropify"  />
                                                        <?php } ?>
                                                    ...
                                                    <div class="card_content">
                                                        <?php if($gallery['gallery_image12']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageGallery/'.$userid.'/galleryF/gallery_image12/'.$gallery['gallery_image12']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title">Image 12</h2>
                                                    <!-- <p class="card_text">Demo of pixel perfect pure CSS simple responsive card grid layout</p>
                                                    <button class="btn card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                        ...
                                        <?php if($gallery['gallery_image1']!="" && $gallery['gallery_image2']!="" && $gallery['gallery_image3']!="" && $gallery['gallery_image4']!="" && $gallery['gallery_image5']!="" && $gallery['gallery_image6']!="" && $gallery['gallery_image7']!="" && $gallery['gallery_image8']!="" && $gallery['gallery_image9']!="" && $gallery['gallery_image10']!="" && $gallery['gallery_image11']!="" && $gallery['gallery_image12']!=""  ) { ?>
                                        <button type="submit" name="addGall1" class="btn btn-primary me-2">Next</button>
                                        <?php } else { ?>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="#" target="_blank">Virtual Card Station</a>2023</span>
