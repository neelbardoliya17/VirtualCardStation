...
@media screen and (min-width: 768px) { /* apply styles only for screens larger than 768px wide */
  .newww {
    height: 275px; 
    justify-content:center;/* set the height to 400px */
  }
  .newww img {
...
@media screen and (max-width: 767px) { /* apply styles only for screens smaller than 768px wide */
  .newww {
    height: auto; 
    justify-content:center;/* reset the height to auto */
  }
  .newww img {
                ...
                <a href="<?php echo base_url().'index.php/admin/theme/'.$userid; ?>"><button type="button" onclick="" class="btn btn-secondary ">Back</button>
                        ...
                        <div class="col-md-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Product Detail Form<br></h4>
                    ...
                    Basic form layout
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <label class="form-label" for="basic-icon-default-message" style="margin-top:10px;margin-left:20px;">As Service</label><br>
                        <label class="switch" style="margin-left:20px;"><input type="checkbox" name="chk" <?php if($product['as_service']==1){ ?> checked
                            <?php } ?>  /><div></div>
                        </label>
                                            ...
                                            <ul class="cards">
                                                ...
                                                <input type="hidden" name="productimage1" value="<?php echo $product['product_image1'] ?>" />
                                                    <div class="card_image">
                                                        <?php if($product['product_image1']!="")
                                                              { ?>
                                                                     <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image1']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                    </div> 
                                                              <?php } else { ?>
                                                    <input type="file" id="product_image1" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" name="product_image1" class="dropify"  />
                                                            <?php } ?> 
                                                    </div>
                                                    <div class="card_content">
                                                         <?php if($product['product_image1']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image1/'.$product['product_image1']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                    ...
                                                    <h2 class="card_title"><input type="text" name="pname1" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name1']; ?>"></h2>
                                                    <p class="card_text"> <label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                    ...
                                                    <!-- <button class="btnnew card_btn">Read More</button> -->
                                                    </div>
                                                </div>
                                                </li>
                                                <li class="cards_item">
                                                ...
                                                <input type="hidden" name="productimage2" value="<?php echo $product['product_image2'] ?>" />
                                                    <div class="card_image"> 
                                                     <?php if($product['product_image2']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image2']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                      </div>
                                                              <?php } else { ?>
                                                    <input type="file"  data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image2" name="product_image2" class="dropify"  /></div>
                                                    <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image2']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image2/'.$product['product_image2']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname2" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name2']; ?>"></h2>
                                                    <p class="card_text"> <label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage3" value="<?php echo $product['product_image3'] ?>" />
                                                    <div class="card_image">  
                                                     <?php if($product['product_image3']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image3']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                  </div>    
                                                              <?php } else { ?>
                                                    <input type="file" id="product_image3" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" name="product_image3" class="dropify"  /></div>
                                                    <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image3']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image3/'.$product['product_image3']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname3" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name3']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage4" value="<?php echo $product['product_image4'] ?>" />
                                                    <div class="card_image"> 
                                                     <?php if($product['product_image4']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image4']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                 </div>     
                                                              <?php } else { ?>
                                                    <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image4" name="product_image4" class="dropify"  /></div>
                                                    <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image4']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image4/'.$product['product_image4']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname4" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name4']; ?>"></h2>
                                                    <p class="card_text"> <label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage5" value="<?php echo $product['product_image5'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image5']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image5']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>      
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image5" name="product_image5" class="dropify"  /></div>
                                                        <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image5']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image5/'.$product['product_image5']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname5" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name5']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage6" value="<?php echo $product['product_image6'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image6']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image6']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>      
                                                              <?php } else { ?> 
                                                    <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image6" name="product_image6" class="dropify"  /></div>
                                                    <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image6']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image6/'.$product['product_image6']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname6" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name6']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage7" value="<?php echo $product['product_image7'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image7']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image7']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                    </div>  
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image7" name="product_image7" class="dropify"  /></div>
                                                        <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image7']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image7/'.$product['product_image7']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname7" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name7']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage8" value="<?php echo $product['product_image8'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image8']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image8']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>      
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image8" name="product_image8" class="dropify"  /></div>
                                                        <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image8']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image8/'.$product['product_image8']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname8" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name8']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage9" value="<?php echo $product['product_image9'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image9']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image9']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>      
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image9" name="product_image9" class="dropify"  /></div>
                                                        <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image9']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image9/'.$product['product_image9']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname9" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name9']; ?>"></h2>
                                                    <p class="card_text"> <label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage10" value="<?php echo $product['product_image10'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image10']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image10']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>      
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image10" name="product_image10" class="dropify"  /></div>
                                                        <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image10']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image10/'.$product['product_image10']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"> <input type="text" name="pname10" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name10']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage11" value="<?php echo $product['product_image11'] ?>" />
                                                    <div class="card_image"> 
                                                     <?php if($product['product_image11']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image11']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>     
                                                              <?php } else { ?>
                                                    <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image11" name="product_image11" class="dropify"  /></div>
                                                    <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image11']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image11/'.$product['product_image11']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname11" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name11']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
                                                ...
                                                <input type="hidden" name="productimage12" value="<?php echo $product['product_image12'] ?>" />
                                                    <div class="card_image">
                                                         <?php if($product['product_image12']!="")
                                                              { ?>
                                                              <div class="newww">
                                                                      <img  src="<?php echo base_url() . 'assets/user_assets/product/' . $product['product_image12']; ?>" />
                                                                      <br>
                                                                      <br> 
                                                                </div>      
                                                              <?php } else { ?>
                                                        <input type="file" data-allowed-file-extensions="png jpg jpeg  webp" data-max-file-size="1M" id="product_image12" name="product_image12" class="dropify"  /></div>
                                                        <?php } ?>
                                                    <div class="card_content">
                                                         <?php if($product['product_image12']!="")
                                                              { ?>
                                                        <a href="<?php echo base_url().'admin/editPageProduct/'.$userid.'/product/product_image12/'.$product['product_image12']; ?>" style="
                                                                      margin-top:10px;
                                                                      padding: 5px 10px;
                                                                      background-color:#dc143c;
                                                                      color: #fff;
                                                                      text-decoration: none;
                                                                      border-radius: 5px;">Edit Image</a><br><br><?php } ?>
                                                    <h2 class="card_title"><input type="text" name="pname12" class="form-control" id="exampleInputUsername1" placeholder="Product Name" value="<?php echo $product['product_name12']; ?>"></h2>
                                                    <p class="card_text"><label class="categories">Select Category</label>
                                                    <?php $data=array();
                                                $data['catt']=explode(",",$product['product_category']);
                                                 ?>
