      ...
      <div class="content-wrapper d-flex align-items-center auth px-0">
        ...
        <div class="row w-100 mx-0">
          ...
          <?php if ($this->session->flashdata('update')) : ?>
                ...
                <meta http-equiv="refresh" content="<?php echo $this->session->userdata('redirect_delay'); ?>;url=<?php echo site_url('admin'); ?>">
          <?php endif; ?>
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light">Enter Password</h6>
              <form class="pt-3" method="POST">
                <!-- <div class="form-group">
                  <input type="text" name="username" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username">
                </div> -->
                <div class="form-group">
                  <input type="hidden"  name="slug" class="form-control form-control-lg" id="exampleInputPassword1" value=<?php echo $slug; ?> />
                </div>
                <div class="form-group">
                  <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" name="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password" required>
                </div>
                <div class="form-group">
                  <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" name="confirm_password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Confirm Password" required>
                </div>
                <div class="mt-3">
                  <input class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" name="chgpassword" value="Submit" />
                </div>
