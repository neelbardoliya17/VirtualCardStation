          ...
          <div class="col-md-12 stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <h4 class="card-title">Theme Detail Form</h4>
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="exampleInputUsername1">Header Color</label>
                    <br>
                    <input type="color" required name="header_color" id="" value="<?php echo $theme['header_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputUsername1">Header Text Color</label>
                    <br>
                    <input type="color" required name="header_text_color" id="" value="<?php echo $theme['header_text_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Button Color</label>
                    <br>
                    <input type="color" required name="button_color" value="<?php echo $theme['button_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">About  Color</label>
                    <br>
                    <input type="color" required name="about_color" value="<?php echo $theme['about_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInpu tEmail1">About Text Color</label>
                    <br>
                    <input type="color" required name="about_text_color" value="<?php echo $theme['about_text_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Footer Color</label>
                    <br>
                    <input type="color" required name="footer_color" value="<?php echo $theme['footer_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Footer Text Color</label>
                    <br>
                    <input type="color" required name="footer_text_color" value="<?php echo $theme['footer_text_color']; ?>">
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="basic-icon-default-message">PopUp Image*<br>(720
                      X 720)(1MB Max)</label>
                    <input type="hidden" name="popup_image2" value="<?php echo $theme['popup_image1']; ?>" />
                    <div class="col-sm-4">
                         <?php if($theme['popup_image1']!="")
                      { ?>
                      <img style="max-width: 100%;height: auto;border:2px solid black;padding:10px;border-radius:5%" src="<?php echo base_url() . 'assets/user_assets/popup/' . $theme['popup_image1']; ?>" />
                      <br>
                      <br> 
                      <a href="<?php echo base_url().'admin/editPageTheme/'.$userid.'/popup/popup_image1/'.$theme['popup_image1'];; ?>" style="
                      margin-top:10px;
                      padding: 5px 10px;
                      ...
                      <?php } else { ?>
                      <input type="file" required data-allowed-file-extensions="png jpg jpeg webp" id="popup_image1" data-max-file-size="1M" name="popup_image1" class="dropify"  />
                        <?php } ?>                                                                                                                    
                    </div>
                  </div>
                  <!-- <div class="form-group">
                  ...
                  <button type="submit" name="addthe" class="btn btn-primary me-2">Next</button>
