              ...
              <div class="card">
                ...
                <a href="<?php echo base_url().'index.php/admin/product/'.$userid; ?>"><button type="button" onclick="" class="btn btn-secondary ">Back</button>
                    ...
                    Basic form layout
                                        ...
                                        <div class="cards">
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 1
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    <input type="hidden" name="bimage1" value="<?php echo $brands['service_image1']; ?>" />
                                                    <div class="">
                                                        <input type="file" id="bimg1" name="bimg1" class="dropify" data-default-file="<?php if ($brands['service_image1'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image1'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 2
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg2" name="bimg2" class="dropify" data-default-file="<?php if ($brands['service_image2'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image2'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 3
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg3" name="bimg3" class="dropify" data-default-file="<?php if ($brands['service_image3'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image3'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 4
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg4" name="bimg4" class="dropify" data-default-file="<?php if ($brands['service_image4'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image4'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 5
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg5" name="bimg5" class="dropify" data-default-file="<?php if ($brands['service_image5'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image5'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 6
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg6" name="bimg6" class="dropify" data-default-file="<?php if ($brands['service_image6'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image6'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 7
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg7" name="bimg7" class="dropify" data-default-file="<?php if ($brands['service_image7'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image7'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 8
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg8" name="bimg8" class="dropify" data-default-file="<?php if ($brands['service_image8'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image8'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand 9
                                                </h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg9" name="bimg9" class="dropify" data-default-file="<?php if ($brands['service_image9'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image9'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                <h4 style="background-color:white;padding:5px;text-align:center;color:black">Brand
                                                    10</h4>
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-icon-default-message">Brand
                                                        Image<br>(1080 X 1080)</label>
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg10" name="bimg10" class="dropify" data-default-file="<?php if ($brands['service_image10'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image10'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg11" name="bimg11" class="dropify" data-default-file="<?php if ($brands['service_image11'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image11'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="card12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="">
                                                        <input type="file" id="bimg12" name="bimg12" class="dropify" data-default-file="<?php if ($brands['service_image12'] != '') {
                                                                                                                                            echo base_url() . 'assets/user_assets/service/' . $brands['service_image12'];
                                                                                                                                        } ?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
