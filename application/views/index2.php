...
<body>
    ...
    <nav id="navigation" class="modern-nav fixed fixed-height fs-12 bs-xs link-hover-01 nav-white nav-lg " data-offset="75">
        <div class="container nav-container" >
            <div class="row nav-wrapper justify-content-end">
                ...
                <? } else { ?>
                <img style="height: 50px; max-width:150px;" src="<? echo base_url().'assets/user_assets/logo/test.png'; ?>" alt="website logo" class="logo-white" > 
                <img src="<? echo base_url().'assets/user_assets/logo/test.png'; ?>" style="height: 50px; max-width:150px;" alt="website logo" class="logo-dark"></a>
                <? } ?>
                </div>
                <div id="nav-menu"
                    class="col ml-auto nav-menu">
                    <ul class="nav-links justify-content-end">
                        <li class="logo-for-mobile-navigation"><? if($detail['logo_image']!="") { ?><img src="<? echo base_url().'assets/user_assets/logo/'.$detail['logo_image']; ?>" alt="website logo" class="logo-white" style="height: 50px; max-width:150px;"><? } else { ?><img src="<? echo base_url().'assets/user_assets/logo/test.png'; ?>" alt="website logo" class="logo-white" style="height: 50px; max-width:150px;"><? } ?></li>
    ...
    <!--    <div class="carousel">-->
    <!--        <img src="<? echo base_url().'assets/user_assets/slider/'.$detail['slider_image2']; ?>" alt="Image 1">-->
  ...
  display: flex;
  justify-content: center;
  align-items: center;" class="swiper-slide nav-to--white" data-bg="<? if($detail['slider_image1']!="") { echo base_url().'assets/user_assets/slider/'.$detail['slider_image1']; } else { echo base_url().'assets/user_assets/slider/test.png'; } ?>" data-swiper-autoplay="3000"></div>
                <div style=" background-size: cover;
  background-position: center;
  height: 100vh; /* adjust as needed */
  display: flex;
  justify-content: center;
  align-items: center;" class="swiper-slide nav-to--white" data-bg="<? if($detail['slider_image2']!="") { echo base_url().'assets/user_assets/slider/'.$detail['slider_image2']; } else { echo base_url().'assets/user_assets/slider/test.png'; } ?>" data-swiper-autoplay="3000"></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-6 mt-30 d-flex flex-column align-items-center hover-container c-default">
                    <div
                        ...
                        <a target="_blank" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']; ?>"><i style="font-size:40px; font-weight:600; color:<? echo $detail['button_color']; ?>;" class="fa fa-whatsapp"></i></a></div>
    ...
    <section class="py-10">
        ...
        @media screen and (max-width: 1200px) {
            .dd1 {
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover" style="text-align: center;">
                    <div class="modern-nav dropdown dd1" style="width: 100%;">
                        <a class="nav-button bg-colored bg-colored1-hover fs-11 uppercase extrabold py-15 dropdown-toggle " data-bs-toggle="dropdown" id="socialshare" aria-haspopup="true"  aria-expanded="true">Social Share<i class="fa fa-arrow-circle-down" style="padding-left: 4px;"></i></a>

<!--                           
                            <button id="socialshare"  class="btn nav-button bg-colored bg-colored1-hover white dropdown-toggle" type="button"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true"
                            style="color:#fff; ">
                            Social Share <i class="fa fa-arrow-circle-down" style="padding-left: 4px;"></i>
                        </button> -->

                            <div class="dropdown-menu" aria-labelledby="socialshare" style="position: relative !important;">
                                <ul class="list-inline">
                                <? if($detail['facebook']!=NULL) { ?>
                                    <li class="list-inline-item m-1">
                                        <a target="_blank" href="<? echo $detail['facebook']; ?>"
                                    ...
                                    <li class="list-inline-item m-1">
                                        <a target="_blank" href="<? echo $detail['instagram']; ?>"
    ...
    <section id="about" class="pt-100 pb-80 has-parallax">
        <div class="parallax" data-bg="<? if($detail['about_image']) { echo base_url().'assets/user_assets/about/'.$detail['about_image']; } else { echo base_url().'assets/user_assets/about/test.png'; } ?>" data-target="#why-we"
        ...
        <div class="container" style="min-height:500px;">
            <div class="row">
                ...
                <div class="col-lg-12" style="text-align: center;">
                    ...
                    <p style="text-align: justify; color:#fff;"><? echo $me; ?></p><br>
                    ...
                    <button class="btn btn-medium btn-greenish dropdown-toggle" type="button" id="" data-bs-toggle="dropdown"
                        aria-haspopup="true" id="openinghr" aria-expanded="true" style="color:#fff;">
                        Opening Hours 
                    </button>

                     <!-- <a class="nav-button bg-colored bg-colored1-hover fs-11 uppercase extrabold py-15 dropdown-toggle" data-bs-toggle="dropdown" id="openinghr" aria-haspopup="true"  aria-expanded="true" style="padding-left:10px;padding-right:10px;"> Opening Hours </a> -->


                    <div class="dropdown-menu" aria-labelledby="openinghr" style="padding-bottom:0px; margin-bottom: 0px ;">
                        <ul class="list-inline" style="padding-bottom:0px; margin-bottom: 0px ;">
                            <li class="list-inline-item m-1" style="padding-bottom:0px; margin-bottom: 0px ;">
                                ...
                                <div class="row">
                                    <div class="col-lg-15"
                                        style="color:black; font-weight: 500; padding-bottom:0px; margin-bottom: 0px ;">
                                      <span style="font-weight:bold;">Monday To Friday:</span>     <? echo $detail['mon_fri']; ?><br>
                                      <span style="font-weight:bold;">Saturday:</span>     <? echo $detail['saturday']; ?><br>
            ...
            <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            ...
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image1']; ?>" alt="">
             ...
             <? } else { ?>
             <div class="container123">
                    <h3 class="title123"></h3>
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/test.png'; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
                                <h3></h3>
                                <!-- <p>This is a short description</p> -->
                            </div>
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123"  height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image2']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
            ...
            <? } else { ?>
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image3']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
            ...
            <? } else { ?>
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image4']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
            ...
            <? if($brands['service_name5']!="") { ?>
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image5']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
            ...
            <? if($brands['service_name6']!="") { ?>
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image6']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image7']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image8']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image9']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image10']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image11']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
             ...
             <div class="container123">
                    ...
                    <div class="content123">
                        <!-- <a href="" target="_blank"> -->
                            <div class="content-overlay123"></div>
                            <img class="content-image123" height="320" src="<? echo base_url().'assets/user_assets/service/'.$brands['service_image12']; ?>" alt="">
                            <div class="content-details123 fadeIn-top123 fadeIn-right123">
        ...
        <div class="container">
            ...
            <div class="portfolioContainer1">
                ...
                <div class="<? echo $product['product_cat1']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image1']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name1']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name1']."*"; ?>">Inquiry Now  <i
                ...
                <div class="">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/test.png'; ?>" alt="image">
                        <div class="z2-client">
                            <h2></h2>
                        </div>
                    </div>
                ...
                <div class="<? echo $product['product_cat2']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image2']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name2']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name2']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat3']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image3']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name3']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name3']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
              <? } else { ?>
                ...
                <div class="<? echo $product['product_cat4']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image4']; ?>" alt="image" >
                        <div class="z2-client design">
                            <h2><? echo $product['product_name4']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name4']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat5']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image5']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name5']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name5']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat6']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image6']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name6']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name6']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat7']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image7']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name7']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name7']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat8']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image8']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name8']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name8']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat9']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image9']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name9']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name9']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat10']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image10']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name10']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name10']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat11']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image11']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name11']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name11']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="<? echo $product['product_cat12']; ?>">
                    <div class='z-hovr'>
                        <img src="<? echo base_url().'assets/user_assets/product/'.$product['product_image12']; ?>" alt="image" >
                        <div class="z2-client">
                            <h2><? echo $product['product_name12']; ?></h2>
                            <a class="showoverlay see_btn" href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['whatsapp_message']."*"; echo $product['product_name12']."*"; ?>">Inquiry Now  <i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>  
                    </div>
                </div>
                        ...
                        <div class="row row-eq-height justify-content-between mx-0">
                            <div class="col-9 px-20 py-20 lh-normal">
                                <h2 class=" mt-3 dark4 lh-normal" title="How long can rocks withstand waves?"><? echo $product['product_name2']; ?></h2>
                                    ...
                                    href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['product_message']."*"; echo $product['product_name2']."*"; ?>"   class="col-3 mxw-80 bl-1 b-gray3 d-flex align-items-center justify-content-center t-center bg-gray-hover"><i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row row-eq-height justify-content-between mx-0">
                            <div class="col-9 px-20 py-20 lh-normal">
                                <h2 class=" mt-3 dark4 lh-normal" title="How long can rocks withstand waves?"><? echo $product['product_name3']; ?></h2>
                                    ...
                                    href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['product_message']."*"; echo $product['product_name3']."*"; ?>"   class="col-3 mxw-80 bl-1 b-gray3 d-flex align-items-center justify-content-center t-center bg-gray-hover"><i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row row-eq-height justify-content-between mx-0">
                            <div class="col-9 px-20 py-20 lh-normal">
                                <h2 class=" mt-3 dark4 lh-normal" title="How long can rocks withstand waves?"><? echo $product['product_name4']; ?></h2>
                                    ...
                                    href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['product_message']."*"; echo $product['product_name4']."*"; ?>"   class="col-3 mxw-80 bl-1 b-gray3 d-flex align-items-center justify-content-center t-center bg-gray-hover"><i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row row-eq-height justify-content-between mx-0">
                            <div class="col-9 px-20 py-20 lh-normal">
                                <h2 class=" mt-3 dark4 lh-normal" title="How long can rocks withstand waves?"><? echo $product['product_name5']; ?></h2>
                                    ...
                                    href="https://wa.me/91<? echo $detail['contact_no']; ?>?text=<? echo $detail['product_message']."*"; echo $product['product_name5']."*"; ?>"   class="col-3 mxw-80 bl-1 b-gray3 d-flex align-items-center justify-content-center t-center bg-gray-hover"><i
                                    class="fa fa-whatsapp fs-25"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section id="gallery" class="py-10" style="background-color:#fafafa">
        ...
        <div class="container mt-30">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image1']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image1']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image1']; ?>" ></a>
                        
                    </div>
                </div>
                <? } else { ?>
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/test.png'; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/test.png'; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/test.png'; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image2']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image2']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image2']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image3']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image3']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image3']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image4']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image4']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image4']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image5']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image5']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image5']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image6']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image6']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image6']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image7']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image7']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image7']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image8']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image8']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image8']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image9']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image9']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image9']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image10']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image10']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image10']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image11']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image11']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image11']; ?>" ></a>
                ...
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <div class="has-overlay animated-container block-img"><a href="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image12']; ?>" data-fancybox="group1" ><img src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image12']; ?>"
                        style="height:320px;"    data-src="<? echo base_url().'assets/user_assets/galleryF/'.$gallery['gallery_image12']; ?>" ></a>
    ...
    <section class="py-50">
        ...
        <div class="container mt-30">
            ...
            <? if($detail['video_link1']!="") { 
                ...
                <? if($detail['video_link1']!="") { ?>
                <div class="col-lg-4 col-sm-6 col-12 mt-30 has-overlay-hover">
                    <iframe width="100%" height="300" src="<? echo $embed_url; ?>" title="YouTube video player"
                    ...
                    <div class="col-xl-8 offset-xl-2 col-lg-12">
                        <div class="text-slider o-hidden fullwidth">
                            <div class="swiper-wrapper">
                                ...
                                <? if($testimonial['testimonial_name2']!=NULL) { ?>
                                <div class="swiper-slide" data-swiper-autoplay="2000">
                                    <div
                                        class="d-flex fullwidth fullheight flex-column align-items-center justify-content-center t-center">
                                ...
                                <div class="swiper-slide" data-swiper-autoplay="2000">
                                    <div
                                        class="d-flex fullwidth fullheight flex-column align-items-center justify-content-center t-center">
                                        <q class="white  bold fs-25 fs-22-sm lh-40 lh-30-sm"><? echo $testimonial['testimonial_description3'] ?></q>
                                        <div class="author-img">
                                    <a href=""><img style="border-radius:50%" src="<? echo base_url().'assets/user_assets/testimonial/'.$testimonial['testimonial_image3']; ?>" alt=""></a>
                                </div>
                                        <abbr class="uppercase mt-30" style="color: #fff;"><? echo $testimonial['testimonial_name3']; ?></abbr>
                                    </div>
                                </div>
                                <? } ?>
                                ...
                                <div class="swiper-slide" data-swiper-autoplay="2000">
                                    <div
                                        class="d-flex fullwidth fullheight flex-column align-items-center justify-content-center t-center">
                                        <q class="white  bold fs-25 fs-22-sm lh-40 lh-30-sm"><? echo $testimonial['testimonial_description4'] ?></q>
                                        <div class="author-img">
                                    <a href=""><img style="border-radius:50%" src="<? echo base_url().'assets/user_assets/testimonial/'.$testimonial['testimonial_image4']; ?>" alt=""></a>
                                </div>
                                        <abbr class="uppercase mt-30" style="color: #fff;"><? echo $testimonial['testimonial_name4']; ?></abbr>
                                    </div>
                                </div>
                                <? } ?>
            ...
            <div class="container py-90">
                <div class="row row-eq-height align-items-center">
                    <div class="col-lg col-12 mt-30-sm">
                        <div class="t-center">
                            <p class="mt-15 gray4 uppercase fs-14 medium" style="color:<? echo $detail['footer_text_color']; ?> !important">©2023 All Rights Reserved.<br>Designed by <a href="https://www.icedinfotech.com/" target="_blank" class="colored underline-hover"  >ICED Infotech</a></p> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="background-color:#fff;">
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<? echo base_url().'assets/user_assets/popup/'.$detail['popup_image1']; ?>" style="width:100%;height:auto;object-fit:contain" alt="">
                        <? } else { ?>
                        <img src="<? echo base_url().'assets/user_assets/popup/test.png'; ?>" style="width:100%;height:auto;object-fit:contain" alt="">
                        <? } ?>
                    </div>
                </div>
            </div>
