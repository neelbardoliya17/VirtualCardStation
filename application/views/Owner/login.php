...
<head>
  ...
  <!-- plugins:css -->
  <link rel="manifest" href="<? echo base_url().'assets/admin_assets/manifest.json';  ?>" >
  ...
  <!-- endinject -->
  <!-- <link rel="shortcut icon" href="<? echo base_url().'assets/admin_assets/images/favicon.png'; ?>" /> -->
  <style>
    .alert-danger {
        ...
        <div class="row w-100 mx-0">
          ...
          <?php endif; ?>
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h2 align="center">ICED INFOTECH</h2>
                <!-- <img src="<? echo base_url().'assets/admin_assets/images/logo.svg'; ?>" alt="logo"> -->
              </div>
              <h4>Digital Card Owner Admin</h4>
              ...
              <form class="pt-3" method="POST">
                ...
                <!--  Don't have an account? <a href="<? echo base_url().'Admin/register'; ?>" class="text-primary">Create</a>-->
                <!--</div>-->
                <!--<div class="text-center mt-4 font-weight-light">-->
                <!--  <a href="<? echo base_url().'Admin/forgetPassword'; ?>" class="text-primary">Forget Password</a>-->
                <!--</div>-->
              </form>
            </div>
          </div>
